...
const getInitialValues = (record: SpmsRecord): SpmsRequestFormValues => ({
  ...
  requestorEmail: record.requestorEmail ?? '',
  requestorPhone: record.requestorPhone ?? '',
  ...
  slaHours: record.slaHours ?? getSlaHoursForSeverity(getFormSeverity(record)),
  awbTransfer: record.awbTransfer ?? '',
  picKancabEmail: record.picKancabEmail ?? '',
  picKancabName: record.picKancabName ?? '',
  picKancabPhone: record.picKancabPhone ?? '',
  pmArea: record.pmArea ?? record.area.toUpperCase(),
  statusTransaction: record.statusTransaction ?? '',
